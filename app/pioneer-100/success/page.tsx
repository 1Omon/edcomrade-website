  ...
  return (
    <main className="min-h-screen bg-background px-6 lg:px-8 py-24">
      <div className="max-w-3xl mx-auto text-center space-y-6">
        ...
        <p className="text-lg text-muted-foreground">We’ve received your ₵1,500 deposit. Our onboarding team will contact you within 24 hours via WhatsApp or email.</p>
