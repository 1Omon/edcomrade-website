...
//             </div>
//             <div className="text-center">
//               <div className="text-3xl font-light text-primary">Jan 2026</div>
...
//               className="bg-white border-2 border-slate-300 px-8 py-4 rounded-full font-medium text-lg hover:border-indigo-600 hover:text-primary transition-all"
//             >
...
//                   <div
//                     className={`w-24 h-24 mx-auto bg-gradient-to-br ${step.color} rounded-2xl flex items-center justify-center text-white text-2xl font-light mb-4 shadow-lg`}
//                   >
//                     {step.num}
//                   </div>
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-light tracking-tight text-center mb-6">
            Join the{" "}
            <span className="text-primary font-medium">Pioneer 100</span>
          </h1>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6 text-center">
              <div className="text-4xl font-light text-primary mb-2">Jan 2026</div>
              <div className="text-sm text-muted-foreground font-medium">National Tour</div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className={`w-14 h-14 rounded-xl bg-${item.color}/10 flex items-center justify-center text-${item.color} mb-6 group-hover:scale-110 transition-transform`}>
                  {item.icon}
                </div>
                <h3 className="text-2xl font-light mb-3">{item.title}</h3>
      ...
      <section className="py-20 px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">Everything you need to stand out in 2026</p>
          </div>
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              ...
              >
                ...
                {expandedFaq === i && <div className="px-6 pb-6 text-muted-foreground">{faq.a}</div>}
              </div>
            ))}
          </div>
        </div>
      ...
      <footer className="py-12 px-6 lg:px-8 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm opacity-70">© 2025 EdComrade. All rights reserved.</p>
        </div>
      </footer>
    </main>
  );
