    ...
    <main className="min-h-screen ">
      ...
      <section className="pt-32 pb-20 px-6 lg:px-8 relative overflow-hidden">
        <div className="max-w-6xl mx-auto relative">
          ...
          <p className="text-xl md:text-2xl text-center  mb-8 max-w-3xl mx-auto leading-relaxed">
          ...
          <p className="text-center text-sm text-slate-500">
            ...
            <a href="/pioneer-100-terms" className="underline hover:text-primary">
              View Terms
            </a>
          </p>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              ...
              <p className="text-slate-400 text-sm">
                Need installments? Contact <a className="hover:underline hover:text-white" href="mailto:edcomrade.gh@gmail.com">edcomrade.gh@gmail.com</a>  for flexible
                payment options.
              </p>
            </div>

            {/* Reserve Form */}
            <div id="reserve" className="bg-white text-foreground rounded-3xl p-8 shadow-2xl">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <p className="text-xs text-slate-500 text-center">
                  Deposit reserves your spot. Refundable until <b>Dec 31, 2025.</b> 
                </p>
              </form>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              ...
              >
                ...
                {expandedFaq === i && (
                  <div className="px-6 pb-6 ">{faq.a}</div>
                )}
              </div>
            ))}
          </div>
      ...
      <footer className="py-12 px-6 lg:px-8 bg-slate-900 text-slate-400 text-sm text-center">
        <div className="max-w-4xl mx-auto">
          <p>
            ...
            Policy.{" "}
            <a href="/pioneer-100-terms" className="underline hover:text-white transition">
              View full terms
            </a>
          </p>
