      ...
      <section className="relative overflow-hidden bg-primary text-white py-20 px-6">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <p className="text-xl text-white/90 mb-6">
            Clear, transparent terms for your school's participation in Ghana's
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2 text-slate-700">
                  ...
                  <p className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>14-day refund processing</strong> after approval
                    </span>
                  </p>
                  <p className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
              ...
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 md:p-12 space-y-12">
                ...
                <section id="deposit">
                  ...
                  <div className="space-y-4 text-slate-700 leading-relaxed">
                    ...
                    <p>
                      Deposits must be made through Paystack, Direct Mobile
                      Money (MTN), or Bank Transfer to EdComrade's designated
                      account(s). The deposit represents a commitment fee
                      confirming the school's interest and enabling scheduling
                      for the January 2026 National Media Tour.
                    </p>
                  </div>
                </section>
                  ...
                  <ul className="space-y-3 text-slate-700">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        ...
                        or future media project within 6 months.
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span>
                        ...
                        <strong>14 business days</strong> of approval and issued
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span>
                        If EdComrade fails to deliver its services or cancels
                        the January 2026 tour without an alternative
                        arrangement,{" "}
                        <strong>all deposits shall be refunded in full</strong>.
                      </span>
                    </li>
                  </ul>
                </section>
                ...
                <section id="scope">
                  ...
                  <p className="text-slate-600 text-sm mt-4">
                    Full deliverables are outlined in the campaign brochure and
                ...
                <section id="scheduling">
                  ...
                  <p className="text-slate-700 leading-relaxed">
                    EdComrade will conduct its National Media Tour across Ghana
                    during <strong>January 2026</strong>, visiting each region
                    to capture registered schools. Schools will be contacted by
                    EdComrade's onboarding team to confirm their specific shoot
                    window. Participants must ensure their campus is accessible
                    and ready for filming on the assigned date.
                  </p>
                </section>
                ...
                <section id="payments">
                  ...
                  <p className="text-slate-700 leading-relaxed">
                    Upon payment of the deposit, the school receives an official
                    digital receipt and onboarding pack by email/WhatsApp.
                    Balances are due before the scheduled shoot date. All
                    payments are logged and acknowledged via official EdComrade
                    channels.
                  </p>
                </section>
                ...
                >
                  ...
                  <p className="text-slate-700 mb-4">
                    To initiate a refund, send an official email including:
                  </p>
                  ...
                  <p className="text-slate-700 mt-4 text-sm">
                    Refund confirmation will be issued within 5 business days of
                    approval. Funds disbursed within 14 business days
                    thereafter.
                  </p>
                </section>
                ...
                {[
                  ...
                  },
                  {
                    ...
                    title: "Liability",
                    content:
                      "EdComrade shall not be held liable for delays caused by acts of God, government restrictions, or unforeseen logistical challenges. In such cases, EdComrade may reschedule affected shoots or issue refunds at its discretion. EdComrade's total liability shall not exceed the total amount paid by the school.",
                  },
                  {
                    id: "data",
                    num: 12,
                    ...
                    content:
                      "All school data and media files are handled under strict confidentiality and used only for onboarding, communication, and service delivery. EdComrade complies with Ghana's Data Protection Act, 2012 (Act 843).",
                  },
                  {
                    id: "law",
                    num: 13,
                    title: "Governing Law",
                    content:
                      "This Agreement is governed by the laws of the Republic of Ghana. Disputes shall first be resolved amicably; failing which, the matter shall be referred to arbitration under Ghanaian law.",
                  },
                  {
                    id: "acceptance",
                    num: 14,
