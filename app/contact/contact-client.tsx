    ...
    <main style={{ background: "var(--paper)" }}>
      ...
      >
        ...
        >
          ...
          >
            Ready to claim your free School Management Software, set up
            ParentAide, or feature your school on EduMedia? Send us a message
            below.
          </p>
        </div>
      </section>
          ...
          >
                ...
                >
                  ...
                  {role === "proprietor" && (
                    <div>
                      ...
                      <input
                        type="text"
                        name="schoolName"
                        placeholder="E.g. St. Francis Academy"
                        style={{
                          width: "100%",
                          padding: "12px 16px",
                          borderRadius: "8px",
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Claim Free Software / Inquiry"
                      style={{
                        width: "100%",
                        padding: "12px 16px",
                        borderRadius: "8px",
            ...
            >
              <div className="card" style={{ padding: "32px" }}>
                ...
                >
                  ...
                  >
                    ...
                    <a
                      href="mailto:partner@edcomrade.com"
                      style={{
                        color: "var(--navy)",
                        fontWeight: 600,
                        textDecoration: "none",
              ...
              >
                ...
                >
                  School heads requesting setup receive a phone callback within
