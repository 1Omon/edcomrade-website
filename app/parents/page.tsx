                ...
                <Container>
                    <div className="max-w-5xl mx-auto text-center space-y-12 pt-48">
                        <h1 className="text-5xl md:text-9xl font-bold tracking-tighter leading-[0.85] text-transparent bg-clip-text bg-gradient-to-b from-foreground to-muted-foreground/50">
                            Your child&apos;s school <br /> <span className="text-secondary italic">in your pocket.</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-6">
                            <Magnetic strength={0.2}>
                                <Button size="xl" variant="secondary" className="rounded-full px-12 text-xl shadow-2xl shadow-secondary/20 h-16" asChild>
                                    <Link href="https://schoolpedia.edcomrade.com">Find a School on Schoolpedia</Link>
                                </Button>
                            </Magnetic>
                    ...
                    <div className="grid lg:grid-cols-2 gap-24 items-center mb-32">
                        ...
                        <div className="space-y-12">
                            <div className="space-y-6">
                                <span className="text-xs font-bold uppercase tracking-[0.4em] text-secondary">Why ParentAide?</span>
                                <h2 className="text-4xl md:text-7xl font-bold tracking-tight text-foreground">Stop chasing <br /> for updates.</h2>
                                <p className="text-lg md:text-2xl text-muted-foreground font-light leading-relaxed">
                                    No more missed announcements, lost report cards, or chasing receipts. ParentAide is the simple bridge between your home and your child&apos;s school.
                                </p>
                            </div>

                            <div className="grid sm:grid-cols-2 gap-8">
                                <FeatureItem icon={Eye} title="Daily Progress" desc="Instant attendance and safety alerts. See what they&apos;re learning and how they&apos;re performing." />
                                <FeatureItem icon={Smartphone} title="Direct Connection" desc="Official school news and announcements delivered directly to your phone. No noise." />
                                <FeatureItem icon={ShieldCheck} title="Verified Payments" desc="Pay fees and see your full payment history and receipts right on your phone." />
                                <FeatureItem icon={History} title="Safe Records" desc="Keep a clear, verified history of your child&apos;s school journey from enrollment to graduation." />
                            </div>
                        </div>
                    </div>
                ...
                <Container className="max-w-4xl">
                    <div className="bg-black text-white rounded-[3rem] p-12 md:p-24 text-center space-y-12 relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-8">
                            <h2 className="text-4xl md:text-7xl font-bold tracking-tighter">Is your school <br /> on EdComrade?</h2>
                            <p className="text-xl md:text-2xl text-zinc-400 font-light leading-relaxed max-w-2xl mx-auto">
                                If your school doesn&apos;t use EdComrade yet, we can help them get started. Refer your school leader today and help your entire school community move forward.
                            </p>
                            <div className="flex flex-col sm:flex-row justify-center gap-6 pt-6">
                                <Magnetic strength={0.2}>
                                    <Button size="xl" variant="secondary" className="rounded-full px-12 text-xl h-16" asChild>
                                        <Link href="https://wa.me/233505617353?text=I'd%20like%20to%20refer%20my%20child's%20school%20to%20EdComrade">Refer My School on WhatsApp</Link>
                                    </Button>
                                </Magnetic>
                                <Magnetic strength={0.1}>
                                    <Button variant="ghost" size="xl" className="text-zinc-400 hover:text-primary transition-colors" asChild>
